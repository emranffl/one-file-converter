...
export default function NotFound() {
  ...
  return (
    <section className="flex grow flex-col items-center justify-center px-4 md:flex-row">
      <div className="container mx-auto flex flex-col items-center md:flex-row">
        {/* // + SVG Illustration */}
        <div className="flex w-full items-center justify-center md:w-1/2">
          <svg
            className="w-full dark:invert dark:filter"
            version="1.1"
        ...
        {/* // + 404 Text and Button */}
        <div className="mt-10 flex w-full flex-col items-center justify-center text-center md:mt-0 md:w-1/2 md:text-left">
          <h1 className="m-0 text-[7.5rem] font-bold leading-none">404</h1>
          <h2 className="mt-4 text-3xl font-bold">Uh, oh! You're lost.</h2>
